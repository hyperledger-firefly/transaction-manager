...
var getEventStreamListener = func(m *manager) *ffapi.Route {
	return &ffapi.Route{
		Name:   "getEventStreamListener",
		...
		QueryParams:     nil,
		Description:     tmmsgs.APIEndpointGetEventStreamListener,
		JSONInputValue:  nil,
		JSONOutputValue: func() interface{} { return &apitypes.Listener{} },
		JSONOutputCodes: []int{http.StatusOK},
		JSONHandler: func(r *ffapi.APIRequest) (output interface{}, err error) {
			return m.GetListener(r.Req.Context(), r.PP["streamId"], r.PP["listenerId"])
		},
	}
}
