...
// GetReceiveChannel provides a mock function with no fields
func (_m *Manager) GetReceiveChannel() chan<- *ffcapi.BlockHashEvent {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetReceiveChannel")
	}
