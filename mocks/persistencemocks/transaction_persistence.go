...
func (_m *TransactionPersistence) InsertTransactionsWithNextNonce(ctx context.Context, txs []*apitypes.ManagedTX, lookupNextNonce txhandler.NextNonceCallback) []error {
